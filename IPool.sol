...
interface IPool is IERC20, IERC2612 {
    ...
    function sellBaseToken(address to, uint128 minFYTokenOut) external returns(uint128);
    function buyBaseToken(address to, uint128 baseTokenOut, uint128 maxFYTokenIn) external returns(uint128);
    function sellFYToken(address to, uint128 minBaseTokenOut) external returns(uint128);
    function buyFYToken(address to, uint128 fyTokenOut, uint128 maxBaseTokenIn) external returns(uint128);
